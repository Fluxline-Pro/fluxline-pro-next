...
This guide shows you how to add a new podcast episode to the "A+ In FLUX Mythmaker" podcast on the Fluxline Pro website.
...
| **podcast_name**     | Show name (optional)                    | `A+ In FLUX Mythmaker`                     |
