...
import { getBlogPosts, getAllTags, getAllCategories } from './blogData';

/**
 * Blog Page Component
 * Displays blog posts in a card grid layout with filtering
 *
 * Features:
...
export default function BlogPage() {
  ...
  // Load blog posts data with filters
