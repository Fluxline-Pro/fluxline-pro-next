    ...
    <div className="flex flex-col gap-8 px-4 py-8 md:px-8 md:py-12">
      ...
      <header className="flex flex-col gap-4">
        ...
        <p className="text-lg md:text-xl max-w-3xl">
          Access our comprehensive collection of strategic insights and frameworks. Each scroll
          offers deep-dive guidance on transforming your business, craft, or personal practice with
      ...
      <section className="mt-8 p-6 md:p-8 rounded-lg border">
        ...
        <p className="mb-6 max-w-2xl">
          These scrolls are gates—curricula for your evolution. Explore the insights that resonate
          with your current phase and discover frameworks designed for sustainable transformation.
        </p>
