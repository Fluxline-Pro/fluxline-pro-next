...
import { getAllScrolls, getScrollById } from '../scrollsData';
  ...
  return (
    <div className="flex flex-col gap-8 px-4 py-8 md:px-8 md:py-12 max-w-4xl mx-auto">
      ...
      <nav className="flex items-center gap-2 text-sm" aria-label="Breadcrumb">
        <Link href="/services" className="hover:underline" style={{ color: 'var(--themePrimary)' }}>
          Services
        </Link>
      ...
      <header className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm" style={{ color: 'var(--neutralSecondary)' }}>
            {scroll.fileSize}
          </span>
        </div>
      ...
      {/* Metadata */}
      <div className="flex flex-wrap gap-6 text-sm" style={{ color: 'var(--neutralSecondary)' }}>
        <div>
      ...
      {/* Download Section */}
      <div className="p-6 rounded-lg border" style={{ borderColor: 'var(--neutralLight)' }}>
        <h2 className="text-xl font-bold mb-4">Download This Scroll</h2>
        <p className="mb-6" style={{ color: 'var(--neutralSecondary)' }}>
          Access the complete strategic insights document in PDF format. Each scroll provides
          in-depth guidance and frameworks for transformation.
        </p>
        <a
          href={scroll.pdfUrl}
          target="_blank"
