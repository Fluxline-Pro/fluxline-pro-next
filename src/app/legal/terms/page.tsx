...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description:
    'Terms of Use for Fluxline. Learn about our service terms, user responsibilities, and legal agreements.',
  keywords:
    'terms of use, terms and conditions, legal, service agreement, Fluxline',
  openGraph: {
    title: 'Terms of Use - Fluxline',
    description:
      'Terms of Use for Fluxline. Learn about our service terms and legal agreements.',
