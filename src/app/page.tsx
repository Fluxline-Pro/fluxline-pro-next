  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-8 gap-8">
      <main className="flex flex-col gap-8 items-center max-w-2xl">
        ...
        <p className="text-center text-lg" style={{ color: theme.palette.neutralPrimary }}>
        ...
        <Card elevation={2} padding="large" hoverable>
          ...
          <p style={{ color: theme.palette.neutralSecondary }}>
            This card demonstrates the theme integration with Fluent UI. 
            The colors, spacing, and shadows are all controlled by the theme system.
          </p>
        </Card>
        ...
        <Card elevation={1} padding="medium">
          ...
          <ul className="list-disc list-inside space-y-2" style={{ color: theme.palette.neutralSecondary }}>
